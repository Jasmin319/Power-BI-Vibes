![Thumbnail](./Thumbnail-Data-Catalog-Obsidian-AI.png)

# Build a Data Catalog for Power BI with Obsidian and AI

In this tutorial, you'll learn how to automatically generate a searchable and visual data catalog from a Power BI PBIP project using Obsidian, GitHub Copilot, and AI.

Instead of manually documenting your semantic model, you'll use AI to generate markdown documentation, connect related objects, and visualize data lineage inside Obsidian.
...
🎥 YouTube: https://www.youtube.com/@BIVibes-JasminSimader

🏠 Website: https://www.jasminsimader.com/

👩🏻‍💻 LinkedIn: https://www.linkedin.com/in/jasmin-simader

📝 Blog / Medium: https://medium.com/@jasminsimader
