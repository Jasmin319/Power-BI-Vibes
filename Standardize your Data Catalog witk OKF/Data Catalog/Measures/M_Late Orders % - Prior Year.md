# Measure: Late Orders % - Prior Year
...
~~~dax
CALCULATE([Late Orders %], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Late Orders % - Prior Year  
**Purpose:** Late Orders % for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Late Orders % for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
