...
~~~dax
CALCULATE([Order Count], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Order Count - MTD  
**Purpose:** Order Count month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Order Count month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
