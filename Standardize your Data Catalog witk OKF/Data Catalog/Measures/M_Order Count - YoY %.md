...
~~~dax
CALCULATE([Order Count], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
### Measure
**Name:** Order Count - YoY %  
**Purpose:** Year-over-year percent change in Order Count. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Order Count. Applies Time Intelligence calculation item 'YoY %'.
