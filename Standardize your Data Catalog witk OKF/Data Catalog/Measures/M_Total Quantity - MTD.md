...
~~~dax
CALCULATE([Total Quantity], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
**Purpose:** Total Quantity month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Total Quantity month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
