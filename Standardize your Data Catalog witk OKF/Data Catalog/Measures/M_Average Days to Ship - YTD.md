# Measure: Average Days to Ship - YTD
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "YTD")
~~~
...
### Measure
**Name:** Average Days to Ship - YTD  
**Purpose:** Average Days to Ship year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
...
### Business Meaning
Average Days to Ship year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
