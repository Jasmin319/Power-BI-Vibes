# Measure: Total Discount Amount - QTD
...
~~~dax
CALCULATE([Total Discount Amount], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Total Discount Amount - QTD  
**Purpose:** Total Discount Amount quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Total Discount Amount quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
