...
~~~dax
CALCULATE([Total Sales], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
**Purpose:** Total Sales quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Total Sales quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
