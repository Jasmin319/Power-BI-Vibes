# Measure: Average Days to Ship - QTD
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Average Days to Ship - QTD  
**Purpose:** Average Days to Ship quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Average Days to Ship quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
