# Measure: Average Days to Ship - MTD
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Average Days to Ship - MTD  
**Purpose:** Average Days to Ship month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Average Days to Ship month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
