# Measure: Late Orders Count - Current
...
~~~dax
CALCULATE([Late Orders Count], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Late Orders Count - Current  
**Purpose:** Late Orders Count for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Late Orders Count for the current period. Applies Time Intelligence calculation item 'Current'.
