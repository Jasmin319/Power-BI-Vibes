...
~~~dax
CALCULATE([Late Orders %], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Late Orders % - Current  
**Purpose:** Late Orders % for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Late Orders % for the current period. Applies Time Intelligence calculation item 'Current'.
