...
~~~dax
CALCULATE([Total Quantity], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
### Measure
**Name:** Total Quantity - YoY %  
**Purpose:** Year-over-year percent change in Total Quantity. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Total Quantity. Applies Time Intelligence calculation item 'YoY %'.
