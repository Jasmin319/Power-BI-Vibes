...
~~~dax
CALCULATE([Order Count], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Order Count - QTD  
**Purpose:** Order Count quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Order Count quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
