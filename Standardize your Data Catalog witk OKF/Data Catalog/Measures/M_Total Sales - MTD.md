...
~~~dax
CALCULATE([Total Sales], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
**Purpose:** Total Sales month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Total Sales month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
