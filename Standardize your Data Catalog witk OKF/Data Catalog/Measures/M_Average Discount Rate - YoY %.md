# Measure: Average Discount Rate - YoY %
...
~~~dax
CALCULATE([Average Discount Rate], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
### Measure
**Name:** Average Discount Rate - YoY %  
**Purpose:** Year-over-year percent change in Average Discount Rate. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Average Discount Rate. Applies Time Intelligence calculation item 'YoY %'.
