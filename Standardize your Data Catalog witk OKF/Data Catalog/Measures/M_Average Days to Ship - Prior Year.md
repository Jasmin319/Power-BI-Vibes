# Measure: Average Days to Ship - Prior Year
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Average Days to Ship - Prior Year  
**Purpose:** Average Days to Ship for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.

### Inputs & Dependencies
**No direct column references:** No

**Used measures:**
- [Average Days to Ship](M_Average%20Days%20to%20Ship.md)
...
### Business Meaning
Average Days to Ship for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
