...
~~~dax
CALCULATE([Order Count], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Order Count - Current  
**Purpose:** Order Count for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Order Count for the current period. Applies Time Intelligence calculation item 'Current'.
