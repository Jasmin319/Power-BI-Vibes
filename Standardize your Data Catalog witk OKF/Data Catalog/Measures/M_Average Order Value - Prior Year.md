# Measure: Average Order Value - Prior Year
...
~~~dax
CALCULATE([Average Order Value], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
**Purpose:** Average Order Value for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Average Order Value for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
