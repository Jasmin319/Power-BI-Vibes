# Measure: Average Order Value - YTD
...
~~~dax
CALCULATE([Average Order Value], 'Time Intelligence'[Time Intelligence] = "YTD")
~~~
...
### Measure
**Name:** Average Order Value - YTD  
**Purpose:** Average Order Value year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
...
### Business Meaning
Average Order Value year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
