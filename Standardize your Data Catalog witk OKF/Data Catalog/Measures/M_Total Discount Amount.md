...
~~~dax
SUMX(Fact_OrderDetail, Fact_OrderDetail[Unit Price] * Fact_OrderDetail[Quantity Ordered] * Fact_OrderDetail[Discount Rate])
~~~
...
**Purpose:** Total discount value given, calculated as Unit Price x Quantity Ordered x Discount Rate across all order lines.
...
### Business Meaning
Total discount value given, calculated as Unit Price x Quantity Ordered x Discount Rate across all order lines.
