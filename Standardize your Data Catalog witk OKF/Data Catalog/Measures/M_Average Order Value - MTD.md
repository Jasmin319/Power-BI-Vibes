# Measure: Average Order Value - MTD
...
~~~dax
CALCULATE([Average Order Value], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Average Order Value - MTD  
**Purpose:** Average Order Value month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Average Order Value month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
