...
~~~dax
CALCULATE([Late Orders %], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
### Measure
**Name:** Late Orders % - YoY %  
**Purpose:** Year-over-year percent change in Late Orders %. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Late Orders %. Applies Time Intelligence calculation item 'YoY %'.
