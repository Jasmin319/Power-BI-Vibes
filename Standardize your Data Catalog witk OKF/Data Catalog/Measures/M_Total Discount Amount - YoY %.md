# Measure: Total Discount Amount - YoY %
...
~~~dax
CALCULATE([Total Discount Amount], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
### Measure
**Name:** Total Discount Amount - YoY %  
**Purpose:** Year-over-year percent change in Total Discount Amount. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Total Discount Amount. Applies Time Intelligence calculation item 'YoY %'.
