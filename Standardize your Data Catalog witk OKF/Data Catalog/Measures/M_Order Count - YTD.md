...
~~~dax
CALCULATE([Order Count], 'Time Intelligence'[Time Intelligence] = "YTD")
~~~
...
**Purpose:** Order Count year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
...
### Business Meaning
Order Count year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
