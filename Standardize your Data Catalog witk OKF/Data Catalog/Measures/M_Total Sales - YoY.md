...
~~~dax
CALCULATE([Total Sales], 'Time Intelligence'[Time Intelligence] = "YoY")
~~~
...
**Purpose:** Year-over-year change in Total Sales (current period minus prior year). Applies Time Intelligence calculation item 'YoY'.
...
### Business Meaning
Year-over-year change in Total Sales (current period minus prior year). Applies Time Intelligence calculation item 'YoY'.
