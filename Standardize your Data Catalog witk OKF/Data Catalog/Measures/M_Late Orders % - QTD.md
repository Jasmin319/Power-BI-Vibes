...
~~~dax
CALCULATE([Late Orders %], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Late Orders % - QTD  
**Purpose:** Late Orders % quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Late Orders % quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
