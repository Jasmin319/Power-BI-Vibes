# Measure: Average Days to Ship - Current
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Average Days to Ship - Current  
**Purpose:** Average Days to Ship for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Average Days to Ship for the current period. Applies Time Intelligence calculation item 'Current'.
