...
~~~dax
CALCULATE([Total Sales], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Total Sales - Current  
**Purpose:** Total Sales for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Total Sales for the current period. Applies Time Intelligence calculation item 'Current'.
