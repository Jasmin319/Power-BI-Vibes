# Measure: Late Orders Count - Prior Year
...
~~~dax
CALCULATE([Late Orders Count], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Late Orders Count - Prior Year  
**Purpose:** Late Orders Count for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Late Orders Count for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
