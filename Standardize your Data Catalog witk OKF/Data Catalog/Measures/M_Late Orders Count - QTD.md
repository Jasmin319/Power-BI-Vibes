...
~~~dax
CALCULATE([Late Orders Count], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Late Orders Count - QTD  
**Purpose:** Late Orders Count quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Late Orders Count quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
