# Measure: Average Days to Ship - YoY %
...
~~~dax
CALCULATE([Average Days to Ship], 'Time Intelligence'[Time Intelligence] = "YoY %")
~~~
...
**Purpose:** Year-over-year percent change in Average Days to Ship. Applies Time Intelligence calculation item 'YoY %'.
...
### Business Meaning
Year-over-year percent change in Average Days to Ship. Applies Time Intelligence calculation item 'YoY %'.
