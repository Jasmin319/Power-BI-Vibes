...
~~~dax
SUM(Fact_OrderDetail[Quantity Ordered])
~~~
...
### Measure
**Name:** Total Quantity  
**Purpose:** Total units sold, calculated as the sum of Quantity Ordered from all order lines in the current filter context.
...
### Business Meaning
Total units sold, calculated as the sum of Quantity Ordered from all order lines in the current filter context.
