...
~~~dax
COUNTROWS(FILTER(Fact_Order, Fact_Order[Days Late] > 0))
~~~
...
### Measure
**Name:** Late Orders Count  
**Purpose:** Count of orders with Days Late > 0 in the current filter context.
...
### Business Meaning
Count of orders with Days Late > 0 in the current filter context.
