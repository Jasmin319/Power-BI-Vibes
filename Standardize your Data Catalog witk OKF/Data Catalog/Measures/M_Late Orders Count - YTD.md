...
~~~dax
CALCULATE([Late Orders Count], 'Time Intelligence'[Time Intelligence] = "YTD")
~~~
...
### Measure
**Name:** Late Orders Count - YTD  
**Purpose:** Late Orders Count year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
...
### Business Meaning
Late Orders Count year-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'YTD'.
