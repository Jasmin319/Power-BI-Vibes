# Measure: Total Sales - Prior Year
...
~~~dax
CALCULATE([Total Sales], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Total Sales - Prior Year  
**Purpose:** Total Sales for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Total Sales for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
