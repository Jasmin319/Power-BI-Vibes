# Measure: Average Discount Rate - QTD
...
~~~dax
CALCULATE([Average Discount Rate], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Average Discount Rate - QTD  
**Purpose:** Average Discount Rate quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Average Discount Rate quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
