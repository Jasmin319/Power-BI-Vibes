# Measure: Average Discount Rate - Prior Year
...
~~~dax
CALCULATE([Average Discount Rate], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Average Discount Rate - Prior Year  
**Purpose:** Average Discount Rate for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Average Discount Rate for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
