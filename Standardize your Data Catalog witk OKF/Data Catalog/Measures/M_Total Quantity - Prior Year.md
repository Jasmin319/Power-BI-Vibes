# Measure: Total Quantity - Prior Year
...
~~~dax
CALCULATE([Total Quantity], 'Time Intelligence'[Time Intelligence] = "Prior Year")
~~~
...
### Measure
**Name:** Total Quantity - Prior Year  
**Purpose:** Total Quantity for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
...
### Business Meaning
Total Quantity for the same period in the prior year. Applies Time Intelligence calculation item 'Prior Year'.
