...
**Purpose:** Average sales per order, calculated as Total Sales divided by Order Count for the current filter context.
...
### Business Meaning
Average sales per order, calculated as Total Sales divided by Order Count for the current filter context.
