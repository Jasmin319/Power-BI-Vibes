# Measure: Average Order Value - Current
...
~~~dax
CALCULATE([Average Order Value], 'Time Intelligence'[Time Intelligence] = "Current")
~~~
...
### Measure
**Name:** Average Order Value - Current  
**Purpose:** Average Order Value for the current period. Applies Time Intelligence calculation item 'Current'.
...
### Business Meaning
Average Order Value for the current period. Applies Time Intelligence calculation item 'Current'.
