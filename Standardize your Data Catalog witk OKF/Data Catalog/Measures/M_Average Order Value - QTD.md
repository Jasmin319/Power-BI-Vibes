# Measure: Average Order Value - QTD
...
~~~dax
CALCULATE([Average Order Value], 'Time Intelligence'[Time Intelligence] = "QTD")
~~~
...
### Measure
**Name:** Average Order Value - QTD  
**Purpose:** Average Order Value quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
...
### Business Meaning
Average Order Value quarter-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'QTD'.
