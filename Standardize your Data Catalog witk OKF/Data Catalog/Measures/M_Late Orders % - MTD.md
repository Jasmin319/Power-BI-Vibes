...
~~~dax
CALCULATE([Late Orders %], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Late Orders % - MTD  
**Purpose:** Late Orders % month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Late Orders % month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
