# Measure: Total Discount Amount - MTD
...
~~~dax
CALCULATE([Total Discount Amount], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Total Discount Amount - MTD  
**Purpose:** Total Discount Amount month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Total Discount Amount month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
