# Measure: Average Discount Rate - MTD
...
~~~dax
CALCULATE([Average Discount Rate], 'Time Intelligence'[Time Intelligence] = "MTD")
~~~
...
### Measure
**Name:** Average Discount Rate - MTD  
**Purpose:** Average Discount Rate month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
...
### Business Meaning
Average Discount Rate month-to-date based on Dim_Calendar[Date]. Applies Time Intelligence calculation item 'MTD'.
